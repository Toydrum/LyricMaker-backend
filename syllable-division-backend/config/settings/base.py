"""
Django settings for syllable-division-backend project.
...
INSTALLED_APPS = [
    ...
    'apps.syllables',  # Your syllables app
    "corsheaders",
]
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.sqlite3',  # Change to your database engine
